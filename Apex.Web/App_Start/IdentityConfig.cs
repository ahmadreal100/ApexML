...
namespace Apex.Web
{
    ...
    public class ApplicationUserManager : UserManager<User, long>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<User, Role, long, UserLogin, UserRole, UserClaim>(context.Get<ApexContext>()));
    ...
    public class ApplicationSignInManager : SignInManager<User, long>
    {
        ...
        public Task<ClaimsIdentity> CreateUserIdentityAsync(User user, Claim opsClaim)
        {
            return user.GenerateUserIdentityAsync((ApplicationUserManager)UserManager);
        }
