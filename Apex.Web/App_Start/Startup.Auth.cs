...
namespace Apex.Web
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            {
                var context = (ApexContext)DependencyResolver.Current.GetService(typeof(ApexContext));
            ...
            app.UseCookieAuthentication(new CookieAuthenticationOptions
            {
                ...
                Provider = new CookieAuthenticationProvider
                {
                    ...
                    OnValidateIdentity = SecurityStampValidator.OnValidateIdentity<ApplicationUserManager, User, long>(
                        ...
                        (manager, user) => user.GenerateUserIdentityAsync(manager), m => m.GetUserId<long>())
                }
            });
